...
<header>
	<img src="/static/images/But-ky-cao-cap-moi-ve.jpg" alt="" width="100%" height="300px">
</header>

<nav id="navbar" class="navbar navbar-expand-sm navbar-dark sticky-top" style="background-color: #FFFFFF; border-bottom: 1px solid gainsboro;">
	<div class="container ">
