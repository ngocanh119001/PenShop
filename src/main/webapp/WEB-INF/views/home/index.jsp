...
<c:set var="cart" value="${sessionScope['scopedTarget.cartService']}" />
              ...
              <div id="demo" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="carousel-item active" >
						<img src="/static/images/slideshow/slide5.jpg" alt="Los Angeles" width="100%" height="342px">
					</div>
					<div class="carousel-item">
						<img src="/static/images/slideshow/banner5.jpg" alt="Los Angeles" width="100%" height="342px">
					</div>
					<div class="carousel-item">
	...
	<div class="row">
	     <div class="col-3"><br><img src="/static/images/giaynho.jpg" width="100%" height="200px" /></div>
	     <div class="col-3"><br><img src="/static/images/giaynho1.jpg" width="100%" height="200px" /></div>
	     <div class="col-3"><br><img src="/static/images/but.jpg" width="100%" height="200px" /></div>
	      <div class="col-3"><br><img src="/static/images/vo.jpg" width="100%" height="200px" /></div>
	</div>
	...
	<br> <img src="/static/images/slideshow/banner5.jpg" width="100%" height="180px" />
	...
	<div class="row">
	     <div class="col-6"><br><img src="/static/images/banner2.jpg" width="100%" height="150px"/></div>
	     <div class="col-6"><br><img src="/static/images/banner3.jpg" width="100%" height="150px" /></div>
	</div>
