			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form class="login100-form validate-form" action="/admin/login" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate="Login is required">
						...
						<input class="input100" type="text" name="id" value="${uid}" placeholder="Tên đăng nhập" autofocus="autofocus">
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div>

					<div class="wrap-input100 rs1 validate-input" data-validate="Password is required">
						<input class="input100" type="password" name="pw" value="${pwd}" placeholder="Mật khẩu" autofocus="autofocus">
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div>
